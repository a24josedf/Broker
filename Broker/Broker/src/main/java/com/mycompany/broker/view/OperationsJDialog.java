...
public class OperationsJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        priceBLabel.setText("Price:*");

        quantityBLabel.setText("Quantity:*");

        cancelBButton.setText("Cancel");

        acceptBButton.setText("Save");
        ...
        operationsTabbedPane.addTab("Buy", sellPanel);

        priceSLabel.setText("Price:*");

        quantitySLabel.setText("Quantity:*");

        cancelSButton.setText("Cancel");

        acceptSButton.setText("Save");
        ...
        operationsTabbedPane.addTab("Sell", buyPanel);
    ...
    public void setBuyPriceField(JTextField priceBTextField) {
        this.priceBTextField = priceBTextField;
    }

    public JTextField getSellPriceField() {
        return priceSTextField;
    }

    public void setSellPriceField(JTextField priceSTextField) {
        this.priceSTextField = priceSTextField;
    }

    public JTextField getBuyQuantityField() {
        return quantityBTextField;
    }

    public void setBuyQuantityField(JTextField quantityBTextField) {
        this.quantityBTextField = quantityBTextField;
    }

    public JTextField getSellQuantityField() {
        return quantitySTextField;
    }

    public void setSellQuantityField(JTextField quantitySTextField) {
